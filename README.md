...
To build the final jar and optimize the XploraAdmin application for production, run:
...
Then navigate to [http://localhost:15694](http://localhost:15694) in your browser.
