...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DESTINATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DESTINATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DESTINATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DESTINATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DESTINATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DESTINATION actions', async () => {
      const arg = 42666;
