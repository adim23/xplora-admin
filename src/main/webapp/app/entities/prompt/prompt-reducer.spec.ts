...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './prompt.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROMPT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROMPT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROMPT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROMPT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROMPT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROMPT actions', async () => {
      const arg = 42666;
