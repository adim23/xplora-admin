...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOURCATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TOURCATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TOURCATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TOURCATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TOURCATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TOURCATEGORY actions', async () => {
      const arg = 42666;
