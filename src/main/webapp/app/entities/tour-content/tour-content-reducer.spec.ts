...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOURCONTENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TOURCONTENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TOURCONTENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TOURCONTENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TOURCONTENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TOURCONTENT actions', async () => {
      const arg = 42666;
