...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './tour-extra-category.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOUREXTRACATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TOUREXTRACATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TOUREXTRACATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TOUREXTRACATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TOUREXTRACATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TOUREXTRACATEGORY actions', async () => {
      const arg = 42666;
