...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOUREXTRA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TOUREXTRA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TOUREXTRA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TOUREXTRA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TOUREXTRA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TOUREXTRA actions', async () => {
      const arg = 42666;
