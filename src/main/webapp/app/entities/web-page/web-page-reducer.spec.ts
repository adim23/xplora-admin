...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './web-page.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEBPAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WEBPAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WEBPAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WEBPAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WEBPAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WEBPAGE actions', async () => {
      const arg = 42666;
