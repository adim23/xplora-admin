...
public class MenuTestSamples {
    ...
    public static Menu getMenuSample1() {
        return new Menu().id(1L).code("code1").uri("uri1").icon("icon1").defaultImage("defaultImage1");
    }

    public static Menu getMenuSample2() {
        return new Menu().id(2L).code("code2").uri("uri2").icon("icon2").defaultImage("defaultImage2");
    }
