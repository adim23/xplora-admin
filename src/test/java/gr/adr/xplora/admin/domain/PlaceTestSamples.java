...
public class PlaceTestSamples {
    ...
    public static Place getPlaceSample1() {
        return new Place().id(1L).code("code1").longitude("longitude1").latitude("latitude1").defaultImage("defaultImage1");
    }

    public static Place getPlaceSample2() {
        return new Place().id(2L).code("code2").longitude("longitude2").latitude("latitude2").defaultImage("defaultImage2");
    }
